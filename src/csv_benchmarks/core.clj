...
(comment
  ...
  ;;
  ;; 1 Million row sample
  ;;
  ;; head (simulated):
  ;; 18264,1.9,2019-07-21 00:00:00+00,1.597,6030338631003,,1292022,
  ...
  ;; 6430911,0.7,2019-07-21 00:00:00+00,1,4451402197108,,995233414,
  
  (require '[criterium.core :as b])
  
  (def path "/home/user/1M.csv") ;; 1M rows
  ...
  ;; 1M "Elapsed time: 3389.566964 msecs"
  ;; 1M "Elapsed time: 2397.786306 msecs"
  ...
  ;; 1M "Elapsed time: 1096.673491 msecs"
  ;;
  ;; with (bench)
  ...
  (b/bench
   (sc/slurp-csv path))
  ;; single pass with (time)
  ;; 1M "Elapsed time: 6094.983367 msecs"
  ;;
  ;; with (bench)
  ...
  ;; single pass with (time)
  ;; 1M "Elapsed time: 3818.361591 msecs"
  ;;
  ;; with (bench)
  ;;   Evaluation count : 60 in 60 samples of 1 calls.
  ...
  ;; Overhead used : 1.435983 ns


  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; data.table library on R. (usually better memory management and
  ;; faster than base-r) fread
  (b/bench
   (->
    (fread path
           :header false
  ...
  ;; 1M Elapsed time: 3507.413101 msecs
  ;;
  ;; with (bench)
  ;; Evaluation count : 60 in 60 samples of 1 calls.
  ...
  ;; Execution time upper quantile : 3.479392 sec (97.5%) Overhead used : 1.435819 ns
